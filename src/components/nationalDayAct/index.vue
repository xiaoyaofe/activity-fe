  ...
  <div class="nationalDayAct">
    ...
    <section class="rewardBox">
      <div v-for="(item,index) in 5" :key="index" :class='["reward",`reward${index}`]'>
        ...
        <button :disabled=isReceive[index] :class="isReceive[index]?'joinBtned':'joinBtn'" @click="JoinBtn(index)"></button>
      </div>
    </section>
  </div>
</template>
    ...
    .rewardBox{
      ...
      .reward{
        ...
        .joinBtn{
          ...
          display:block;
          margin: auto;
          background: url("../../assets/20190913/pc/tit1Joinbtn.png")no-repeat center;
        }
        .joinBtned{
         width: 140px;
          height: 46px;
          display:block;
          margin: auto;
          background: url("../../assets/20190913/pc/tit1Joinbtned.png")no-repeat center;
        }
      }
      .reward0{
        margin-left: 28px;
