...
export default Vue.extend({
  ...
  watch: {
    rewardArr(newValue, oldValue) {
      this.rewardIcon =
        "rewardIcon" +
        CONFIG["data"].rewardId.rotate.indexOf(newValue[0].rewardId);
  ...
  .DialogTip {
    ...
    .cdkBox {
      ...
      .close {
        ...
        height: 30px;
        border: none;
        background: url("../../components/login/img/close.png")no-repeat center;
        background-size: contain;
        outline: none;
        position: absolute;
        top: 25px;
  ...
  .DialogTip {
    ...
    .cdkBox {
      ...
      .close {
        ...
        border: none;
        border-radius: 50%;
        background: url("../../components/login/img/close.png");
        background-size: contain;
        outline: none;
        position: absolute;
        top: 25px;
